...
The IsaacGym environment load robot models from the assets/ folder.
For better project structure, we have referred assets/ to ../leap_description/ with a soft link.
Before launching RL training, please re-establish the soft link

```
ln -s ./assets <path-to-your-RGMC_XL>/leap_ws/src/leap_description/assets
```

# Official comments from LEAP Hand repository
