...
from isaacgym.torch_utils import torch_rand_float, quat_from_angle_axis, quat_from_euler_xyz, quat_mul, tensor_clamp, to_torch, get_euler_xyz
...
class LeapHandGrasp(LeapHandRot):
    ...
    def reset_idx(self, env_ids, goal_env_ids=None):
        ...
        if self.random_reset_method == 'original':
            ...
            delta_rot = randomize_rotation_three_axis(delta_rpy[:, 0], delta_rpy[:, 1], delta_rpy[:, 2], \
