            ...
            if self.rank == 0:
                ...
                if self.game_rewards.current_size > 0:
                    ...
                    for i in range(self.value_size):
                        self.writer.add_scalar("rewards/frame".format(), mean_rewards[i], frame)
                        self.writer.add_scalar("rewards/iter".format(), mean_rewards[i], epoch_num)
                        self.writer.add_scalar("rewards/time".format(), mean_rewards[i], total_time)
