...
from isaacgym.torch_utils import quat_mul, quat_from_euler_xyz, quat_from_angle_axis, to_torch
import torch
...
fixed_rot2 = randomize_rotation_three_axis(fixed_rpy[:, 0], fixed_rpy[:, 1], fixed_rpy[:, 2], x_unit_tensor, y_unit_tensor, z_unit_tensor)
