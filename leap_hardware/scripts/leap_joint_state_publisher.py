...
DEFAULT_LEAP_DOF_LOWER = np.array([-0.3140, -1.0470, -0.5060, -0.3660, -0.3490, -0.4700, -1.2000, -1.3400,
                                   -0.3140, -1.0470, -0.5060, -0.3660, -0.3140, -1.0470, -0.5060, -0.3660])
DEFAULT_LEAP_DOF_UPPER = np.array([2.2300, 1.0470, 1.8850, 2.0420, 2.0940, 2.4430, 1.9000, 1.8800, 2.2300,
...
def node_main():
    ...
    while not rospy.is_shutdown():
        ...
        leap_joint_state.name = ["joint_{}".format(i) for i in real_to_sim_indices]
