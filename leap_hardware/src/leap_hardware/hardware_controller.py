...
class LeapHand(object):
    def __init__(self):
        ...
        self.current_joint_positions = np.zeros(16,)
        self.current_joint_velocities = np.zeros(16,)
    ...
    def poll_fingertip_state(self, ordered_link_names=None):
        ...
        self.leap_kin.updateFKvel(
            part_name="hand",
            part_joint_pos=pin_q,
            part_joint_vel=pin_v
        )
        ...
        if ordered_link_names is not None:
            ...
            fingertip_link_names = ['finger1_tip_center', 'finger2_tip_center', 'finger3_tip_center', 'thumb_tip_center']
    ...
    def publish_leap_joint_states(self):
        ...
        leap_joint_state.name = ["joint_{}".format(i) for i in self.real_to_sim_indices]
